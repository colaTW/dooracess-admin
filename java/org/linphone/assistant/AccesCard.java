...
public class AccesCard extends Activity {
                    ...
                    public void onClick(View view) {
                        if (checkinfo()) {
                            ...
                            try {
                                ...
                                URL url =
                                        new URL(
                                                "http://18.181.171.107/riway/api/v1/clients/temporary/card");
                                ...
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface arg0, int arg1) {
                                        try {
                                            ...
                                            URL url =
                                                    new URL(
                                                            "http://18.181.171.107/riway/api/v1/clients/temporary/unbind/card");
                                            HttpClient httpClient = new DefaultHttpClient();
                                            HttpPost httpPost = new HttpPost(url.toURI());
    ...
    void getlist() {
        ...
        try {
            HttpGet httpGet =
                    new HttpGet("http://18.181.171.107/riway/api/v1/clients/temporary/card");
            HttpClient httpClient = new DefaultHttpClient();
